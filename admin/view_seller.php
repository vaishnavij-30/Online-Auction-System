...
<script type="text/javascript">
  ...
  {
    var a=confirm("Do you really want to disapprove for this seller...!");
    if(a==true)
    {
      window.location.href='disapprove.php?sid='+val;
    }
    else
    {
...
while($row=mysqli_fetch_row($res))
{
  if($row[8]=='appr')
  {
    ...
    <td>$row[0]</td>
    <td>
    <img src=".$row[9]." style='height:100px;width:100px'>
    </td>
    <td>$row[1]</td>
    <td>$row[2]</td>
    <td>$row[3]</td>
    ...
    <td style='text-align:center'>
      <button onclick='disapprove($row[0])' class='btn btn-secondary' style='background-color:green'>
