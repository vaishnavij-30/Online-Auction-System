...
<?php
  ...
  $res = mysqli_query($a,"SELECT * FROM category WHERE ID = '".$_GET['id_a']."'");
              ...
              <form action="update_category.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $row[1]?>" placeholder="Enter name" name="cname">
...
if(isset($_POST['save']))
{
  ...
  if(mysqli_query($a,"UPDATE category SET Name ='".$name."' WHERE ID = '".$id."'"))
  {
    echo'<script>
