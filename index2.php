        ...
        ?>      
                <div class="categories__item  set-bg">  
                    <div class="categories__text">
                        ...
                        <h2 style="font-family: Trebuchet MS; color: black;" class="" >
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <u>Welcome&nbsp;<?php echo $name[1]?>...!</u></h2> 
                    </div>
                </div>
                </div>
            <!-- <div class="col-lg-6">
...
<section class="banner set-bg" data-setbg="hd.jpg">
    <div class="container">
        <div class="row">
