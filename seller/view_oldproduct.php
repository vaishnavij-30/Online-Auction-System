            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
$res=mysqli_query($a,"SELECT * FROM old_product WHERE SID='".$_SESSION['user']."'");
while($row=mysqli_fetch_row($res))
{
  $category=mysqli_fetch_row(mysqli_query($a,"SELECT * FROM category WHERE ID='".$row[1]."'"));
  $scategory=mysqli_fetch_row(mysqli_query($a,"SELECT * FROM sub_category WHERE ID='".$row[7]."'"));
  ...
  echo"<tr>
    ...
    <td>$row[2]</td>
    <td>
    <img src=".$row[8]." style='height:100px;width:100px'>
    </td>
    <td>$row[3]</td>
    <td>$row[4]</td>
    <td>$row[5]</td>
    <td>
      <button class='btn btn-primary'>
        <a style='color:#fff;text-decoration: none;' href='update_oldproduct.php?id=".$row[0]."'>
    ...
    <td>
      <button class='btn btn-danger'>
        <a style='color:#fff;text-decoration: none;' href='delete_oldproduct.php?id_b=".$row[0]."'>
