        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-secondary">
              ...
              <form action="update_oldproduct.php" method="POST">
                <div class="card-body">
                  <div class="form-group">
                  	<!-- <input type="file" class="form-control" name="img"> -->
                    
                    <label>Product Name</label>
                    <input type="text" class="form-control" value="<?php echo $row[2]?>" placeholder="Enter name of the product" name="pname"><br>
                    <input type="hidden" class="form-control" value="<?php echo $row[0]?>" placeholder="Enter name of the product" name="id">
                    <label>Product Original Price</label>
                    <input type="number" class="form-control" value="<?php echo $row[3]?>" placeholder="Original price" name="oprice"><br>
                    <label>Product Selling Price</label>
                    <input type="number" class="form-control" value="<?php echo $row[4]?>" placeholder="Selling price" name="sprice"><br>
                  </div>
                  <label>Date and time:</label>
                    <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                        <input type="text" name="days" class="form-control datetimepicker-input" data-target="#reservationdatetime"/ value="<?php echo $row[5]?>">
...
if(isset($_POST['save']))
{
  ...
  if(mysqli_query($a,"UPDATE old_product SET Name='".$name."',OPrice='".$oprice."' ,SPrice='".$sprice."',No_of_days='".$days."' WHERE ID = '".$id."'"))
  {
    echo'<script>
    alert("Old Product Updated");
