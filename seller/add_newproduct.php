              ...
              <form action="add_newproduct.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control"  placeholder="Start price" name="price"
                    style="border-top: 1px solid #0000;border-left: 1px solid #0000; border-right: 1px solid 
                      #0000;">
                  </div>
...
date_default_timezone_set('Asia/Kolkata'); 
  ...
  $days =date('d-m-Y h:i a', strtotime($d2));
  $scategory=$_POST['scategory'];

$max1=mysqli_query($a,"SELECT MAX(ID) FROM new_product");
$max=mysqli_fetch_row($max1);
  ...
  $file_exists=array("jpg","jpeg","png","gif","bmp","pdf");//file extenssions supported for upload 
        ...
        else
        {
            ...
            {
             $newname="$max_id"."_Newproduct.png"; 
  ...
  if(mysqli_query($a,"INSERT INTO new_product VALUES('','".$category."','".$name."','".$price."','".$days."',
    '".$_SESSION['user']."','".$scategory."','".$targetfile."')"))
  {
    echo'<script>
    alert("New Product Added");
    window.location.href="add_newproduct.php";
    </script>';
  }
  else
  {
