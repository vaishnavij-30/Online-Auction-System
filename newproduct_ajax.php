<?php
  $a = mysqli_connect("localhost","root","","Auction_system")or die("database error");
    ...
    $name=mysqli_query($a,"SELECT * FROM new_product WHERE category_id='".$_POST['cat_id']."'");
...
$new_date_format =date('d-m-Y h:i a', strtotime($bdata[4]));
                    ...
                    <div class="row">
                        <div class="col-lg-6 p-0">
                            <div class="discount__pic">
                                <img src="seller/'.$bdata[7].'" style="height:370px;width:280px;" alt="">
                            </div>
                        </div>
                        <div class="col-lg-6 p-0">
                            <div class="discount__text">
                                ...
                                <a href="newproductbid.php?id='.$bdata[0].' ">Bid now</a>
                            </div>
                        </div>
                    </div>
                </div>
